...
> [!TIP]
> Founder of **[M Paper](https://paper.imurad.me)** & **[LocalSlack](https://localslack.imurad.me)**.  
...
> [!NOTE]
> **M-Paper impact (last 30 days):** 3,230+ unique people onboarded, 136,750+ requests served, 964 MB of data delivered. No ads, no funding—just product. Try it: [paper.imurad.me](https://paper.imurad.me)
...
| [AbabilX ⚙️](https://github.com/AbabilX)                                         | Independent product studio shipping AI-native communication and dev tools (Kothos, Transformate, Ababil Studio).                                                                                 | Next.js, Rust, Electron, WebAssembly         |
| [M-Paper ✏️](https://paper.imurad.me)                                            | Visual workflow layer for sketching with shared canvas, markdown+code notes, AI drawing, and offline P2P.                                                                                        | Next.js, WebRTC, IndexedDB                   |
